...
$ch = curl_init();
$site_url = "http://api.rawapps.com/api/rawapps_widget?format=json&source=market&type=month&cat=productivity";
...
function productivity_rawapps_style() {
?>
<style type="text/css">
	.item-space{
           margin-left:38px;
